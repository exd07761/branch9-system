...
import { auth, firebaseInitError } from "./firebase-init.js?v=0.9.7";
import { getOrCreateUserRole } from "./users-data.js?v=0.9.7";
import { can } from "./permissions.js?v=0.9.7";
